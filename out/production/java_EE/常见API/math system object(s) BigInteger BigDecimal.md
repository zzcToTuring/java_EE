...
查看API文档我们可以看到，在Object类中提供了一个无参构造方法
...
算有意义，怎么实现呢？此时我们就需要在Student类中重写Object的toString方法。我们可以通过idea开发工具进行实现，具体结果如下所示：
...
那么要比较对象的属性，我们就需要在Student类中重写Object类中的equals方法。equals方法的重写，我们也可以使用idea开发工具完成，具体的结果如下所示：
...
<font color="red" size="3">**构造方法**</font>
要用BigDecimal类，那么就需要首先学习一下如何去创建BigDecimal的对象。
我们接下来就重点介绍一下常见的成员方法。
